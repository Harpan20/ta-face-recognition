<x-layout>
    ...
    <!-- BEGIN: Content -->
    <div class="content">
        <h2 class="intro-y mt-10 text-lg font-medium">{{ __('Visions List') }}</h2>
        <div class="mt-5 grid grid-cols-12 gap-6">
            <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
                <a class="btn btn-primary mr-2 shadow-md" href="{{ route('visions.create') }}">
                    {{ __('Add New Vision') }}
                </a>
                {{-- <div class="dropdown">
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                <table class="table-report -mt-2 table">
                    <thead>
                        <tr>
                            <th class="whitespace-nowrap">{{ __('VISION') }}</th>
                            ...
                            <tr class="intro-x">
                                <td>
                                    ...
                                    <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                        NO. {{ $visions->firstItem() + $loop->index }}
                                    </div>
                                </td>
                                <td class="table-report__action w-56">
                                    <div class="flex items-center justify-center">
                                        ...
                                        <a class="flex items-center text-danger" href="javascript:;"
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $vision->id }}">
        ...
        @forelse ($visions as $vision)
            <div class="modal" id="delete-confirmation-modal-{{ $vision->id }}" tabindex="-1" aria-hidden="true">
