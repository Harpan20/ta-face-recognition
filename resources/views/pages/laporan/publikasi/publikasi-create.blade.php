    ...
    <!-- start page content-->
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Laporan Publikasi</div>
                <div class="ps-3">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                      <li class="breadcrumb-item"><a href="javascript:;"><ion-icon name="home-outline"></ion-icon></a>
                      </li>
                      <li class="breadcrumb-item active" aria-current="page">Tambah Laporan Publikasi</li>
                    </ol>
                  </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Tambahkan Laporan Publikasi</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                            <div class="flex-start d-flex" >
                                <a class="btn btn-primary" href="{{route('publikasi.index')}}"><ion-icon name="chevron-back-sharp"></ion-icon>Kembali</a>
                            </div>
                            <br>
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" enctype="multipart/form-data" action="{{route('publikasi.store')}}" method="POST">
                                @csrf
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Nama Laporan</label>
                                    <input type="text" class="form-control" name="nama_laporan" value="{{old('nama_laporan')}}"  required>
                                    @error('nama_laporan')
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="validationCustom01" class="form-label">Bulan Awal</label>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="validationCustom01" class="form-label">Bulan Akhir</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control" name="dokumen_publikasi"  required>
                                    @error('dokumen_publikasi')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_publikasi" class="form-control">{{old('deskripsi_publikasi')}}</textarea>
                                </div>
