                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="flex-start d-flex" >
                                <a class="btn btn-primary" href="{{route('publikasi.detail',$laporan->id_publikasi)}}"><ion-icon name="chevron-back-sharp"></ion-icon>Kembali</a>
                            </div>
                            <br>
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" enctype="multipart/form-data" action="{{route('publikasi.update',$laporan->id_publikasi)}}" method="POST">
                                @csrf
                                @method('put')
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Nama Laporan</label>
                                    <input type="text" class="form-control" name="nama_laporan" value="{{$laporan->nama_laporan}}" required>
                                    @error('nama_laporan')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_publikasi" class="form-control">{!! $laporan->deskripsi_publikasi !!}</textarea>
