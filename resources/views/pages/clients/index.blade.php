<x-layout>
    ...
    <div class="content">
                ...
                <div class="intro-y box col-span-12 md:col-span-6 xl:col-span-4">
                    <div class="flex items-center border-b border-slate-200/60 px-5 py-4 dark:border-darkmode-400">
                        <div class="image-fit h-10 w-10 flex-none">
                            <img
                                class="rounded-full"
                                src="{{ handle_get_image_from_db($client->image) }}"
                                alt="{{ $client->name }}"
                            >
                        </div>
                                ...
                                <ul class="dropdown-content">
                                    ...
                                    <li>
                                        <a
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $client->id }}"
                                            href="javascript:;"
                                        >
                                            <i
                                                class="mr-2 h-4 w-4"
        ...
        @forelse ($clients as $client)
            <div
                class="modal"
                id="delete-confirmation-modal-{{ $client->id }}"
                aria-hidden="true"
                tabindex="-1"
            >
