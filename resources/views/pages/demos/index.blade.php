<x-layout>
    ...
    <div class="content">
                ...
                <table class="table-report -mt-2 table">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">{{ __('NEEDS') }}</th>
                            ...
                            <tr class="intro-x">
                                <td class="w-auto">
                                    ...
                                    <div class="whitespace-nowrap">
                                        {{ __('Company : ') }}{{ $demo->company_name }}
                                    </div>
                                    <div class="whitespace-nowrap">
                                        {{ __('Email : ') }}{{ $demo->email }}
                                    </div>
                                    <div class="whitespace-nowrap">
                                        {{ __('Phone Number : ') }}{{ $demo->country->dial_code }}{{ $demo->number }}
                                    </div>
                                    <div class="whitespace-nowrap">
                                        {{ __('Industry : ') }}{{ $demo->industry }}
                                    </div>
                                    <div class="whitespace-nowrap">
                                        {{ __('Product : ') }}{{ $demo->product->name }}
                                    </div>
                                    <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                        NO. {{ $demos->firstItem() + $loop->index }}
                                    </div>
                                </td>
                                <td>
                                    {{ $demo->needs }}
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex items-center justify-center">
                                        {{-- <a
                                            ...
                                            href="{{ route('contact-forms.edit', $demo->id) }}"
                                        >
                                            <i
                                                class="mr-1 h-4 w-4"
                                        ...
                                        <a
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $demo->id }}"
                                            href="javascript:;"
                                        >
                                            <i
                                                class="mr-1 h-4 w-4"
        ...
        @forelse ($demos as $demo)
            <div
                class="modal"
                id="delete-confirmation-modal-{{ $demo->id }}"
                aria-hidden="true"
                tabindex="-1"
            >
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <form
                                action="{{ route('contact-forms.destroy', $demo->id) }}"
                                method="POST"
                            >
                                @csrf
                                @method('delete')
