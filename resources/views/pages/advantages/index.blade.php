<x-layout>
    ...
    <!-- BEGIN: Content -->
    <div class="content">
        <h2 class="intro-y mt-10 text-lg font-medium">{{ __('Advantages List') }}</h2>
        <div class="mt-5 grid grid-cols-12 gap-6">
            <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
                <a
                    class="btn btn-primary mr-2 shadow-md"
                    href="{{ route('advantages.create') }}"
                >
                    {{ __('Add New Advantage') }}
                </a>
                {{-- <div class="dropdown">
                ...
                {{ $advantages->links('pagination.info') }}
                            ...
                            <tr class="intro-x">
                                    ...
                                    <div class="flex">
                                        <div class="image-fit zoom-in h-10 w-10">
                                            <img
                                                ...
                                                src="{{ handle_get_image_from_db($advantage->icon) }}"
                                ...
                                <td>
                                    ...
                                    <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                        NO. {{ $advantages->firstItem() + $loop->index }}
                                    </div>
                                </td>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex items-center justify-center">
                                        <a
                                            ...
                                            href="{{ route('advantages.edit', $advantage->id) }}"
                                        >
                                            <i
                                                class="mr-1 h-4 w-4"
                                        ...
                                        <a
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $advantage->id }}"
                                            href="javascript:;"
                                        >
                                            <i
                                                class="mr-1 h-4 w-4"
            ...
            <div class="intro-y col-span-12 flex flex-wrap items-center sm:flex-row sm:flex-nowrap">
                {{ $advantages->links('pagination.page') }}
        ...
        @forelse ($advantages as $advantage)
            <div
                class="modal"
                id="delete-confirmation-modal-{{ $advantage->id }}"
                aria-hidden="true"
                tabindex="-1"
            >
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <form
                                action="{{ route('advantages.destroy', $advantage->id) }}"
                                method="POST"
                            >
                                @csrf
                                @method('delete')
