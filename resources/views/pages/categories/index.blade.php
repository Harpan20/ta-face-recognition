<x-layout>
    ...
    <!-- BEGIN: Content -->
    <div class="content">
        <h2 class="intro-y mt-10 text-lg font-medium">{{ __('Categories List') }}</h2>
        <div class="mt-5 grid grid-cols-12 gap-6">
            <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
                <a class="btn btn-primary mr-2 shadow-md" href="{{ route('categories.create') }}">
                    {{ __('Add New Category') }}
                </a>
                {{-- <div class="dropdown">
                ...
                {{ $categories->links('pagination.info') }}
                            ...
                            <tr class="intro-x">
                                <td>
                                    ...
                                    <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                        NO. {{ $categories->firstItem() + $loop->index }}
                                    </div>
                                </td>
            ...
            <div class="intro-y col-span-12 flex flex-wrap items-center sm:flex-row sm:flex-nowrap">
                {{ $categories->links('pagination.page') }}
        ...
        @forelse ($categories as $category)
            <div class="modal" id="delete-confirmation-modal-{{ $category->id }}" tabindex="-1" aria-hidden="true">
