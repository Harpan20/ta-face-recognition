        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Tambah Karir</li>
                    </ol>
                  </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Tambahkan Karir</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                            <div class="flex-start d-flex" >
                                <a class="btn btn-primary" href="{{route('karir.index')}}"><ion-icon name="chevron-back-sharp"></ion-icon>Kembali</a>
                            </div>
                            <br>
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="{{route('karir.store')}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('post')
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Judul Lowongan</label>
                                    <input type="text" class="form-control" value="{{old('judul_karir')}}" name="judul_karir"  required>
                                    @error('judul_karir')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" value="{{old('posisi_karir')}}" name="posisi_karir"   required>
                                    @error('posisi_karir')
                                        <span class="text-danger" style="font-size: 10px;">{{"Karakter harus lebih dari 3"}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_karir" class="form-control">{{old('deskripsi_karir')}}</textarea>
