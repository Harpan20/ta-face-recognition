@extends('layouts.app',['tittle'=>'Edit Status Karir'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Update Status {{$karir->judul_karir}}</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="{{route('karir.updateStatus',$karir->id_karir)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Karir</label>
                                    <select class="form-control" name="status_karir">
                                        @if ($karir->status_karir == 'Publish')
                                            <option selected>Publish</option>
                                            <option>Tidak Publish</option> 
                                        @elseif($karir->status_karir== 'Tidak Publish')
