@extends('layouts.app', ['tittle' => 'Tambah Tata Kelola Perusahaan'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Tambahkan Tata Kelola Perusahaan</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="p-4 border rounded">
                                ...
                                <form class="row g-3 needs-validation"
                                    action="{{ route('admin.tata-kelola-perusahaan.store') }}"
                                    method="POST"
                                    novalidate>
                                    @csrf
