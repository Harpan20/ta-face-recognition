                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0 align-items-center">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">Detail E-form Deposito</li>
                        </ol>
                    </nav>
                </div>
                <br>
                <div class="ms-auto">
                    <div class="btn-group">
                        <a class="btn btn-outline-primary"
                            href="{{ route('deposito.editStatus', $deposito->id_eform_deposito) }}">Update Status</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <p>Rp {{ number_format(floatval($deposito->rencana_nominal), 0, ',', '.') }}</p>
                    </div>
                    <hr>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <p>{{ $deposito->jangka_waktu }} Bulan</p>
                    </div>
                    <hr>
                    <div class="col-md-12">
