@extends('layouts.app',['tittle'=>'Edit Layanan'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Edit Layanan</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="{{route('layanan.update',$layanan->id_layanan)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_layanan" class="form-control">{!!$layanan->deskripsi_layanan !!}</textarea>
