@extends('layouts.app',['tittle'=>'Edit Promo'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Edit Promo</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                            <div class="flex-start d-flex" >
                                <a class="btn btn-primary" href="{{route('promo.detail',$promo->id_promo)}}"><ion-icon name="chevron-back-sharp"></ion-icon>Kembali</a>
                            </div>
                            <br>
                          <div class="p-4 border rounded">
                            @if(session()->has('notif'))
                             ...
                             @endif
                            <form class="row g-3 needs-validation" action="{{route('promo.update',$promo->id_promo)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')

                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Nama Promo</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_promo" class="form-control">{!!$promo->deskripsi_promo !!}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="mulai_promo" class="form-label">Mulai</label>
                                            <input class="form-control @error('mulai_promo') is-invalid @enderror" id="mulai_promo" name="mulai_promo" type="datetime-local" value="{{ old('mulai_promo', $promo->mulai_promo) }}">
                                            @error('mulai_promo')
                                        ...
                                        <div class="col-md-6">
                                            <label for="akhir_promo" class="form-label">Akhir</label>
                                            <input class="form-control @error('akhir_promo') is-invalid @enderror" id="akhir_promo" name="akhir_promo" type="datetime-local" value="{{ old('mulai_promo', $promo->akhir_promo) }}">
                                            @error('akhir_promo')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
