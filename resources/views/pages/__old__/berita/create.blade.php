@extends('layouts.app',['tittle'=>'Tambah Berita'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Tambahkan Berita</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                            <div class="flex-start d-flex" >
                                <a class="btn btn-primary" href="{{route('berita.index')}}"><ion-icon name="chevron-back-sharp"></ion-icon>Kembali</a>
                            </div>
                            <br>
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" method="POST" enctype="multipart/form-data" action="{{route('berita.store')}}">
                                @csrf
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control" name="banner_berita"   required>
                                    @error('banner_berita')
                                        <span class="text-danger" style="font-size: 10px;">{{"Format gambar harus png, jpg, atau jpeg"}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_berita" class="form-control"></textarea>
