@extends('layouts.app',['tittle'=>'Edit Berita'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Edit Berita</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            @if(session()->has('notif'))
                             ...
                             @endif
                            <form class="row g-3 needs-validation" action="{{route('berita.update',$berita->id_berita)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="editor" name="deskripsi_berita" class="form-control">{!!$berita->deskripsi_berita !!}</textarea>
