@extends('layouts.app',['tittle'=>'Tabel Berita'])
...
<div class="page-content-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                <a class="btn btn-outline-primary" href="{{route('berita.create')}}">Tambah Berita</a>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-actions d-flex align-items-center gap-2 fs-6 text-white">
                                                    <a href="{{route('berita.detail',$berita->id_berita)}}" class="btn btn-warning text-light"><ion-icon name="eye-sharp"></ion-icon></a>
                                                    <form method="POST" enctype="multipart/form-data" action="{{route('berita.delete',$berita->id_berita)}}">
                                                        @method('delete')
                                                        @csrf
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="table-responsive mt-3">
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    @foreach ($nopublish as $key => $berita)
                                        <tr>
