@extends('layouts.app',['tittle'=>'Tambah Sejarah'])
@section('content')
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Tambah Sejarah</li>
                    </ol>
                  </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Tambahkan Sejarah</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                            <div class="flex-start d-flex" >
                                <a class="btn btn-primary" href="{{route('sejarah.index')}}"><ion-icon name="chevron-back-sharp"></ion-icon>Kembali</a>
                            </div>
                            <br>
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" enctype="multipart/form-data" method="POST" action="{{route('sejarah.store')}}" novalidate>
                                @csrf
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Judul</label>
                                    <input type="text" class="form-control" name="judul_sejarah" value="{{old('judul_sejarah')}}" required>
                                    @error('judul_sejarah')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="subjudul_sejarah" value="{{old('subjudul_sejarah')}}" required>
                                ...
                                <div class="col-md-12">
                                        <textarea id="editor" name="deskripsi" class="form-control">{{old('deskripsi_sejarah')}}</textarea>
                                </div>
