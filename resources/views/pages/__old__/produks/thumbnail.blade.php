        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Update Thumbnail {{$produk->nama_produk}}</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="{{route('produk.updateThumbnail',$produk->id_produk)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')
                                <div class="col-md-12">
