@extends('layouts.app',['tittle'=>'Tambah Range'])
@section('content')
    <div class="page-content-wrapper">
    <!-- start page content-->
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Range Produk</div>
                <div class="ps-3">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0 align-items-center">
                      <li class="breadcrumb-item"><a href="javascript:;"><ion-icon name="home-outline"></ion-icon></a>
                      </li>
                      <li class="breadcrumb-item active" aria-current="page">Tambah Range</li>
                    </ol>
                  </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Tambahkan Range</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="{{route('range.store',$produk->id_produk)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('post')
                                <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="input-group mb-3"> <span class="input-group-text">Rp.</span>
                                                    <input type="number" class="form-control" name="nominal_min[]"  value="{{old('nominal_min')}}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="input-group mb-3"> <span class="input-group-text">Rp.</span>
                                                    <input type="number" class="form-control" name="nominal_max[]"  value="{{old('nominal_max')}}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
