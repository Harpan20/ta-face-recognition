@extends('layouts.app', ['tittle' => 'Edit Visi'])
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Edit Visi</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="p-4 border rounded">
                                ...
                                <form class="row g-3 needs-validation"
                                    action="{{ route('admin.visi.update', $visi->id) }}"
                                    method="POST"
                                    novalidate>
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="body"
                                            name="body"
                                            class="form-control"
                                            data-editor>{{ old('body', $visi->body) }}</textarea>
                                        @error('body')
