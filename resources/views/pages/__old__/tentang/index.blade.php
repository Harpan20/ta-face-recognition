        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ps-3">
                ...
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tabel Tentang Kami</li>
                </ol>
                </nav>
            </div>
            <div class="ms-auto">
                <div class="btn-group">
                <a class="btn btn-outline-primary" href="{{route('tentang.create')}}">Tambah Tentang Kami</a>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive mt-3">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$tentangs->firstItem()+$key}}</td>
                                <td>{{$tentang->judul_tentang}}</td>
                                <td>{{$tentang->created_at}}</td>
                                <td>{{$tentang->updated_at}}</td>
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-2 fs-6 text-white">
                                        <a class="btn btn-warning text-light" href="{{route('tentang.detail',$tentang->id_tentang)}}"><ion-icon name="eye-sharp"></ion-icon></a>
                                        <form action="{{route('tentang.delete',$tentang->id_tentang)}}" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            @method('delete')
