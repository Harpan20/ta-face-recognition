@extends('layouts.app',['tittle'=>'Edit Gambar Tentang Kami'])
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            ...
                            @endif
                            <form class="row g-3 needs-validation" action="{{route('tentang.updateGambar',$tentang->id_tentang)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')
                                <div class="col-md-12">
