@extends('layouts.app', ['tittle' => 'Tabel Misi'])
                    ...
                    <div class="row gap-2">
                        ...
                        <div class="col-md-4">
                            <form class="d-flex justify-content-md-end gap-2"
                                action="{{ route('admin.misi.search') }}"
                                method="get">
                            ...
                            <tbody>
                                @foreach ($misis as $misi)
                                    <tr>
                                        ...
                                        <td class="text-wrap">{{  $misi->body  }}</td>
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-2 fs-6 text-white">
                                                <a class="btn btn-primary text-light"
                                                    href="{{ route('admin.misi.edit', $misi->id) }}">
                                                    <ion-icon name="pencil-sharp"></ion-icon>
                                                </a>
                                                <form action="{{ route('admin.misi.destroy', $misi->id) }}"
