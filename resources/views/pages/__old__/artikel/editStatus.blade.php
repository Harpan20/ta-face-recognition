        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Update Status {{$artikel->judul_artikel}}</h6>
                    <hr/>
                    <div class="card">
                        <div class="card-body">
                          ...
                          <div class="p-4 border rounded">
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                             ...
                             @endif
                            <form class="row g-3 needs-validation" action="{{route('artikel.updateStatus',$artikel->id_artikel)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('put')
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" name="status_artikel">
                                        ...
                                        @elseif($artikel->status_artikel== 'Tidak Publish')
