@extends('layouts.app', ['tittle' => 'Tabel Nilai'])
                    ...
                    <div class="row gap-2">
                        ...
                        <div class="col-md-4">
                            <form class="d-flex justify-content-md-end gap-2"
                                action="{{ route('admin.nilai.search') }}"
                                method="get">
