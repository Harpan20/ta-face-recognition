<x-layout>
    ...
    <!-- BEGIN: Content -->
    <div class="content">
        <h2 class="intro-y mt-10 text-lg font-medium">{{ __('Supports List') }}</h2>
        <div class="mt-5 grid grid-cols-12 gap-6">
            <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
                ...
                {{ $supports->links('pagination.info') }}
                            ...
                            <tr class="intro-x">
                                    ...
                                    <div class="flex">
                                        <div class="image-fit zoom-in h-10 w-10">
                                            <img
                                                ...
                                                src="{{ handle_get_image_from_db($support->icon) }}"
                                                title="{{ $support->name }}"
                                                alt="{{ $support->name }}"
                                            >
                                        </div>
                                ...
                                <td>
                                    ...
                                    <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                        NO. {{ $supports->firstItem() + $loop->index }}
                                    </div>
                                </td>
                                <td class="table-report__action w-56">
                                    <div class="flex items-center justify-center">
                                        ...
                                        <a
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $support->id }}"
                                            href="javascript:;"
                                        >
                                            <i
                                                class="mr-1 h-4 w-4"
            ...
            <div class="intro-y col-span-12 flex flex-wrap items-center sm:flex-row sm:flex-nowrap">
                {{ $supports->links('pagination.page') }}
        ...
        @forelse ($supports as $support)
            <div
                class="modal"
                id="delete-confirmation-modal-{{ $support->id }}"
                aria-hidden="true"
                tabindex="-1"
            >
