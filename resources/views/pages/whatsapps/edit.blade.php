    ...
    <div class="content">
        ...
        <div class="mt-5 grid grid-cols-12 gap-6">
            <div class="intro-y col-span-12 lg:col-span-6">
                <!-- BEGIN: Form Layout -->
                <form action="{{ route('whatsapps.update', $whatsapp->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="intro-y box p-5">
                            ...
                            <div class="mt-2">
                                <select
                                    ...
                                    @forelse ($countries as $country)
                                        <option value="{{ $country->id }}" @selected(old('country_id', $whatsapp->country_id) == $country->id)>
                        ...
                        <div class="mt-3">
                            ...
                            <input class="form-control {{ $errors->has('number') ? 'border-danger' : '' }} w-full"
                                ...
                                name="number" value="{{ old('number', $whatsapp->number) }}">
                            <div class="form-help">
                        ...
                        <div class="mt-3">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input {{ $errors->has('is_main') ? '!border-danger' : '' }}"
                                    ...
                                    value="{{ old('is_main', $whatsapp->is_main) }}" @checked(old('is_main') || $whatsapp->is_main == '1')>
