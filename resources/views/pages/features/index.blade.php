<x-layout>
    ...
    <!-- BEGIN: Content -->
    <div class="content">
        <h2 class="intro-y mt-10 text-lg font-medium">{{ __('Features List') }}</h2>
        <div class="mt-5 grid grid-cols-12 gap-6">
            <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
                <a class="btn btn-primary mr-2 shadow-md" href="{{ route('features.create') }}">
                    {{ __('Add New Feature') }}
                </a>
                {{-- <div class="dropdown">
                ...
                {{ $features->links('pagination.info') }}
                            ...
                            <tr class="intro-x">
                                <td>
                                    ...
                                    <div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">
                                        NO. {{ $features->firstItem() + $loop->index }}
                                    </div>
                                </td>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex items-center justify-center">
                                        ...
                                        <a class="flex items-center text-danger" href="javascript:;"
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $feature->id }}">
            ...
            <div class="intro-y col-span-12 flex flex-wrap items-center sm:flex-row sm:flex-nowrap">
                {{ $features->links('pagination.page') }}
        ...
        @forelse ($features as $feature)
            <div class="modal" id="delete-confirmation-modal-{{ $feature->id }}" tabindex="-1" aria-hidden="true">
