    ...
    <div class="content">
        ...
        <div class="intro-y mt-5 grid grid-cols-12 gap-6">
            ...
            @foreach ($testimonies as $testimony)
                <div class="intro-y box col-span-12 md:col-span-6 xl:col-span-4">
                    <div class="flex items-center border-b border-slate-200/60 px-5 py-4 dark:border-darkmode-400">
                        {{-- <div class="image-fit h-10 w-10 flex-none">
                            <img class="rounded-full" alt="Midone - HTML Admin Template"
                                src="{{ handle_get_image_from_db($testimony->image) }}">
                        </div> --}}
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a
                                            class="dropdown-item"
                                            href="{{ route('testimonies.edit', $testimony->id) }}"
                                        >
                                            <i
                                                class="mr-2 h-4 w-4"
                                                data-lucide="edit-2"
                                    ...
                                    <li>
                                        <a
                                            ...
                                            data-tw-target="#delete-confirmation-modal-{{ $testimony->id }}"
                                            href="javascript:;"
                                        >
                                            <i
                                                class="mr-2 h-4 w-4"
                    ...
                    <div class="p-5">
                        ...
                        {{-- <a class="mt-5 block text-base font-medium" href="">{{ $testimony->name }}</a> --}}
            ...
            <div class="intro-y col-span-12 flex flex-wrap items-center sm:flex-row sm:flex-nowrap">
                {{ $testimonies->links('pagination.page') }}
        ...
        @forelse ($testimonies as $testinomy)
            <div
                class="modal"
                id="delete-confirmation-modal-{{ $testinomy->id }}"
                aria-hidden="true"
                tabindex="-1"
            >
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body p-0">
                            <form
                                action="{{ route('testimonies.destroy', $testinomy->id) }}"
                                method="POST"
                            >
                                @csrf
                                @method('delete')
