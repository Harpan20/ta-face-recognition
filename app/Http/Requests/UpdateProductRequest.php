...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'image_feature' => ['nullable', 'image', 'mimes:png,jpg,jpeg,svg', 'max:2048'],
            'image_benefit' => ['nullable', 'image', 'mimes:png,jpg,jpeg,svg', 'max:2048'],
            'image_benefit_mobile' => ['nullable', 'image', 'mimes:png,jpg,jpeg,svg', 'max:2048'],
        ];
    }
}
