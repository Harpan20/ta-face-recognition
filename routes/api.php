...
use App\Http\Controllers\API\V1\PromoClaimController;
...
Route::group(['prefix' => 'v1'], function () {
    ...
    // post
    // Route::apiResource('articles', ArticleController::class)->scoped(['article' => 'slug'])->only('index', 'show');
    ...
    // promo
    Route::apiResource('promos', PromoController::class)->only('index');
    Route::apiResource('promo-claims', PromoClaimController::class)->only('store');
});
